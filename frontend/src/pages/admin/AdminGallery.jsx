    ...
    <div data-testid="admin-gallery">
      ...
      <div className="bg-white border-2 border-fsc-negro rounded-xl p-5 mb-8 fsc-card-shadow">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <ImageUpload value={adding.image_url} onChange={(v) => setAdding({ ...adding, image_url: v })} label="Imagen" hint="Recomendado: JPG horizontal 1200×800 px (proporción 3:2). Se recorta tipo cover centrado si la proporción no coincide exacto." testId="gallery-upload" />
