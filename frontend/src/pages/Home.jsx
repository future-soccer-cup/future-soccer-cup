      ...
      <section className="pt-12 pb-20 lg:pb-0 bg-white" data-testid="home-region">
        ...
        <div className="relative max-w-7xl mx-auto px-6 overflow-x-hidden lg:overflow-x-visible">
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 items-start" data-testid="home-categories">
            ...
            <div className="hidden lg:block" style={{ minHeight: "980px" }} data-testid="mascot-box" />
            {/* PREMIER */}
            <div className="relative z-10">
              <CategoryColumn
          ...
          {s.mascot_image_url && (
            <div className="hidden lg:block absolute bottom-0 left-1/2 -translate-x-1/2 pointer-events-none z-0" style={{ height: "980px" }} data-testid="mascot-box-img-wrap">
