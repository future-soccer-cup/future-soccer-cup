        ...
        <div className="p-10 md:p-12">
              ...
              <form onSubmit={submit} className="space-y-5" data-testid="login-modal-form">
                ...
                <div className="flex items-center gap-3 pt-2 flex-wrap">
                  ...
                  <button
                    type="button"
                    onClick={goForgot}
                    className="text-white/90 text-sm md:text-base underline hover:text-white"
          ...
          {view === "forgot" && (
            <div data-testid="login-modal-forgot-form">
              <button type="button" onClick={backToLogin} className="flex items-center gap-1 text-white/80 hover:text-white text-sm md:text-base font-bold uppercase tracking-widest mb-6" data-testid="forgot-back-to-login">
          ...
          {view === "reset" && (
            <div data-testid="login-modal-reset-form">
              <button type="button" onClick={backToLogin} className="flex items-center gap-1 text-white/80 hover:text-white text-sm md:text-base font-bold uppercase tracking-widest mb-6" data-testid="reset-back-to-login">
                <ArrowLeft size={14} /> Volver a Ingresar
              </button>
              <div className="text-white mb-2" style={{ ...AGENCY_FB, fontWeight: 800, fontSize: "clamp(1.8rem, 3.4vw, 2.6rem)", lineHeight: 1.05 }}>
