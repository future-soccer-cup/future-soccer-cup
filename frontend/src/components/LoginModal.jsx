        ...
        <div className="p-10 md:p-12">
          ...
          {view === "forgot" && (
            <div data-testid="login-modal-forgot-form">
              <button type="button" onClick={backToLogin} className="flex items-center gap-1 text-white/80 hover:text-white text-xs font-bold uppercase tracking-widest mb-6" data-testid="forgot-back-to-login">
          ...
          {view === "reset" && (
            <div data-testid="login-modal-reset-form">
              <button type="button" onClick={backToLogin} className="flex items-center gap-1 text-white/80 hover:text-white text-xs font-bold uppercase tracking-widest mb-6" data-testid="reset-back-to-login">
                <ArrowLeft size={14} /> Volver a Ingresar
              </button>
              <div className="text-white mb-2" style={{ ...AGENCY_FB, fontWeight: 800, fontSize: "clamp(1.8rem, 3.4vw, 2.6rem)", lineHeight: 1.05 }}>
