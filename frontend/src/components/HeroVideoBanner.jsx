...
export default function HeroVideoBanner({ videoUrl, imageUrl, testId = "hero-video-banner", heightClass = "aspect-[16/5]" }) {
  ...
  return (
    <div className={`relative w-full ${heightClass} overflow-hidden bg-slate-900`} data-testid={testId}>
      {videoUrl ? (
        ...
        <img src={imgSrc(imageUrl)} alt="" className="w-full h-full object-cover object-center" loading="eager" />
      )}
    </div>
  );
}
